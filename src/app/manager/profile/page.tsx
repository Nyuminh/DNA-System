  ...
  return (
    <div className="container mx-auto px-6 py-8">
      ...
      <div className="relative mb-8">
        <div className="h-48 rounded-lg" style={{ background: 'linear-gradient(90deg, #099D67 0%, #0fbf7f 100%)' }}></div>
        <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 flex items-end">
          <div className="relative">
            <div className="w-32 h-32 bg-white rounded-full border-4 border-white shadow-lg overflow-hidden">
              {profile.avatar ? (
                ...
                <div className="w-full h-full bg-[#e6f7f1] flex items-center justify-center">
                  <UserCircleIcon className="w-20 h-20 text-[#099D67]" />
                </div>
              )}
            </div>
            <button className="absolute bottom-0 right-0 bg-[#099D67] text-white p-2 rounded-full hover:bg-[#13c08a] transition shadow-lg">
          ...
          <div className="ml-6 mb-4">
            ...
            <p className="text-[#d1f5ea]">{profile.position}</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 mt-20">
        <div className="bg-white rounded-lg shadow-md p-6 transform hover:scale-105 transition-transform duration-300">
          <div className="flex items-center justify-between">
            ...
            <div className="bg-[#e6f7f1] p-3 rounded-full">
              <ClipboardDocumentListIcon className="h-6 w-6 text-[#099D67]" />
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-md p-6 transform hover:scale-105 transition-transform duration-300">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          {activeTab === 'profile' && (
            <div className="space-y-6">
              ...
              <div className="bg-[#e6f7f1] border-l-4" style={{ borderColor: '#099D67' }} >
                <div className="flex">
                  <div className="flex-shrink-0">
                    ...
                    <p className="text-sm" style={{ color: '#099D67' }}>
              ...
              <div className="flex justify-end mt-6">
                <button
                  type="button"
                  className="bg-[#099D67] text-white px-4 py-2 rounded-lg hover:bg-[#13c08a] transition"
                >
                  Lưu thay đổi
                </button>
              </div>
