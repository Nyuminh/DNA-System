          ...
          <div className="mt-24">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Thu mẫu tận nơi</h3>
                <p className="mt-2 text-gray-600">
                  Nhân viên của chúng tôi sẽ đến tận nhà hoặc địa điểm yêu cầu để thực hiện việc lấy mẫu xét nghiệm.
                  Phương pháp này tiện lợi cho những người không thể đến cơ sở y tế.
                </p>
                <ul className="mt-4 text-sm text-gray-600 list-disc list-inside">
                  <li>Đặt lịch hẹn thu mẫu tại nhà</li>
                  <li>Nhân viên y tế đến địa điểm</li>
                  <li>Thu mẫu chuyên nghiệp</li>
                  <li>Giao kết quả tận nơi hoặc nhận qua email</li>
                </ul>
              </div>
            </div>
          </div>
